...
export const demo = {
  ...
  items: definitions.map(([slot, name, stars, grade, lines, additional], index) => ({
    ...
    item_description: '예시 장비의 강화 상태와 잠재능력입니다.', item_gender: '공용', equipment_level_increase: 0,
    ...
    potential_line_grades: grade === '레전드리' ? ['legendary', 'unique', 'unique'] : ['unique', 'epic', 'epic'],
    additional_potential_option_1: '공격력 : +10', additional_potential_option_2: 'STR : +2%', additional_potential_option_3: '최대 HP : +100',
    additional_potential_line_grades: additional === '유니크' ? ['unique', 'epic', 'epic'] : additional === '에픽' ? ['epic', 'rare', 'rare'] : ['rare', 'rare', 'rare'],
