...
import { potentialGradeLabels, potentialGradeOrder } from '../shared/potential';

const gradeSlugs = Object.fromEntries(Object.entries(potentialGradeLabels).map(([slug, label]) => [label, slug]));
const partSlugs = {
...
export default function PotentialOptionsDialog({ item, open, onClose }) {
  ...
  const [selectedTargetGrade, setSelectedTargetGrade] = useState(null);
